        ...
        frame.addKeyListener(
            new KeyAdapter() {
                ...
                public void keyPressed(KeyEvent e){
                    ...
                    System.err.printf("Next position %d, %d\n", nextX, nextY);
                    ...
                    switch(field[nextX][nextY].type) {
                        ...
                        case Box -> {
                            ...
                            switch(field[boxNextX][boxNextY].type) {
                                ...
                                case Player -> {
                                    TestShowcase(field);
                                    System.err.println("Failed in running! #Map multiple players.(4)");
                                    System.exit(1);
                                }
                                case TargetWithPlayer -> {
                                    TestShowcase(field);
                                    System.err.println("Failed in running! #Map multiple players.(5)");
                                    System.exit(1);
                                }
                                case TargetWithBox -> {
                                    //Blocked
    ...
    public void TestShowcase(Field field[][]) {
        ...
        for(int i = 1; i <= currentMap.getHeight(); ++i)
            for(int j = 1; j <= currentMap.getWidth(); ++j)
                System.out.printf("%s%c", field[i][j].type.toString(), j == currentMap.getWidth() ? '\n' : ' ');
